...
class Bootstrap5 extends ThemeBase
{
    ...
    {
        return Theme::table('row-border table-hover table-checkable table-highlight-head mb-2')
            ->div('table-responsive col-md-12', 'margin: 10px 0 10px;')
            ->thead('')
            ->thAction('')
            ->tdAction('')
            ->tr('')
            ->th('', 'white-space: nowrap;min-width: 50px;font-size: 0.80rem;color: #1F2937;padding-top: 8px;padding-bottom: 8px;')
            ->tbody('', 'font-size: 0.9rem')
