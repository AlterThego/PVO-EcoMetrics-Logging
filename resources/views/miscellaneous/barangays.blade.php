...
<x-app-layout>
    <div class="pt-12 pb-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-2">
                ...
                <div data-modal-target="barangaysModal"
                    class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm p-6 flex items-center justify-end z-10">
                    <button id="barangaysModalButton" data-modal-target="barangaysModal" data-modal-toggle="barangaysModal"
    ...
    <div class="py-1">
        ...
        <!-- Main modal -->
        <div id="barangaysModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            data-modal-toggle="barangaysModal">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('miscellaneous.barangays.store') }}" method="post">
                        @csrf
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function(event) {
                document.getElementById('barangaysModalButton').click();
            });
        </script>
</x-app-layout>
