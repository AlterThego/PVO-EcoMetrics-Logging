<title>Fish Production Types</title>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" style="position: relative; z-index: 10;">
            <div class="bg-white dark:bg-gray-900 bg-opacity-90 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <livewire:fish-production-table />
                </div>
            </div>
        </div>
        ...
        <div id="fishProductionModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('fish.production.store') }}" method="post">
                        @csrf
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="type" id="type"
                                    ...
                                    placeholder="Input Fish Production Type" required="" autocomplete="off">
                            </div>
                        </div>
                        <button type="submit"
