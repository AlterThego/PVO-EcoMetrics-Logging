            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    <label for="municipality_name"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Municipality Name</label>
                    <input wire:model="municipalityName" type="text" name="municipality_name" id="municipality_name"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Enter Municipality Name" required autocomplete="off">
                </div>

                <div>
                    <label for="zip_code"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zip Code</label>
                    <input wire:model="zipCode" type="text" name="zip_code" id="zip_code"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                ...
                <div>
                    ...
                    <input wire:model="landArea" type="text" name="land_area" id="land_area"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        placeholder="Enter Land Area" required autocomplete="off">
                </div>
