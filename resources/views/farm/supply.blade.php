        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-2">
                ...
                <div data-modal-target="animalPopulationModal"
                    ...
                    <a href="{{ route('farm-supplies.generate-excel') }}" data-tooltip-target="export-tooltip"
        ...
        <div id="animalPopulationModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('farm.supply.store') }}" method="post">
                        @csrf
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                <div>
                                    ...
                                    <input type="text" name="establishment_name" id="establishment_name"
                                        ...
                                        placeholder="Type Establishment Name" required="" autocomplete="off">
                                </div>
                            </div>
                        </div>
