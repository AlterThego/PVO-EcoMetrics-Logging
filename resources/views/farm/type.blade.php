...
<x-app-layout>
    <div class="pt-12 pb-5">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-2">
                ...
                <div data-modal-target="farmTypeModel"
                    class="bg-white dark:bg-gray-900 overflow-hidden shadow-sm p-6 flex items-center justify-end z-10">
                    <button id="farmTypeModalButton" data-modal-target="farmTypeModal"
                        data-modal-toggle="farmTypeModal"
    ...
    <div class="py-1">
        ...
        <!-- Main modal -->
        <div id="farmTypeModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('farm.type.store') }}" method="post">
                        @csrf
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="type" id="type"
                                    ...
                                    placeholder="Input Farm Type" required="" autocomplete="off">
                            </div>
                        </div>
                        <button type="submit"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function(event) {
                document.getElementById('farmTypeModalButton').click();
            });
        </script>
