...
final class FishProductionAreaTable extends PowerGridComponent
{
    ...
    public function actions(FishProductionArea $row): array
    {
        $actions = [];
        if (!$row->trashed()) {
            $actions[] = Button::add('update-modal.fish-production-area-update')
                ...
                ->openModal('update-modal.fish-production-area-update', ['fishProductionAreaUpdateId' => $row->id]);
            ...
            $actions[] = Button::add('restore-row')
                ...
                ->openModal('restore-row', ['fishProductionAreaId' => $row->id]);
        }
        return $actions;
    }
