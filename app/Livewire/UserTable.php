...
final class UserTable extends PowerGridComponent
{
    ...
    { {
            $actions = [];
            if (!$row->trashed()) {
                $actions[] = Button::add('update-modal.user-update')
                    ...
                    ->openModal('update-modal.user-update', ['userUpdateId' => $row->id]);
                ...
                $actions[] = Button::add('delete-row')
                    ...
                    ->openModal('delete-row', ['userId' => $row->id]);
                ...
                $actions[] = Button::add('restore-row')
                    ...
                    ->openModal('restore-row', ['userId' => $row->id]);
            }
            return $actions;
        }
    }
