...
class AffectedAnimalsExport extends Controller
{
    public function generateExcel()
    {
        ...
        $sheet->setCellValue('A5', 'Affected Animals Count');
        ...
        $data = AffectedAnimals::orderBy('year', 'desc')->get();
        ...
        $sheet->setCellValue('E7', 'Affected Animals Count');
        ...
        $tempFilePath = tempnam(sys_get_temp_dir(), 'affected_animals_');
        // Save the Excel file to the temporary path
        $writer = new Xlsx($spreadsheet);
        $writer->save($tempFilePath);

        // Download the Excel file
        $fileName = 'benguet_affected_animals.xlsx';
